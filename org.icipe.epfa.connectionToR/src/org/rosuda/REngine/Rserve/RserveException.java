...
public class RserveException extends REngineException {
    ...
    public String getRequestErrorDescription(final int code) {
        switch(code) {
    ...
    public RserveException(final RConnection c, final String msg) {
        this(c,msg,-1);
    }

    public RserveException(final RConnection c, final String msg, final int requestReturnCode) {
        super(c, msg);
        reqReturnCode=requestReturnCode;
		if (c!=null) c.lastError=getMessage();
    }

	public RserveException(final RConnection c, final String msg, final RPacket p) {
