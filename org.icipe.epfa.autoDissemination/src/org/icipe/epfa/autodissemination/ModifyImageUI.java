	...
	private void modifyImage(){
		try {
			...
			if(MainPageWizardPage.getSeveralModels())
				AutoDissemination.estimateParameters(c,model, true, false, "", "", "", "", "", "", "");
			else{
				String str1,str2,str3,str4,str5,str6,str7;
				str1 = AutoDissemination.pars.getParameters()[0];
				str2 = AutoDissemination.pars.getParameters()[1];
				str3 = AutoDissemination.pars.getParameters()[2];
				str4 = AutoDissemination.pars.getParameters()[3];
				str5 = AutoDissemination.pars.getParameters()[4];
				str6 = AutoDissemination.pars.getParameters()[5];
				str7 = AutoDissemination.pars.getParameters()[6];
				AutoDissemination.estimateParameters(c,model, false, true, str1, str2, str3, str4, str5, str6, str7);
			}
						
			c.eval("shapprueba<-prueba(model,datashap,datao,ini,corrx,corry,punt="+AutoDissemination.strMinP+":" + AutoDissemination.strMaxP + ",labx, laby, titulo)");
